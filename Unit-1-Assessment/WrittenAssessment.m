...
- (NSDictionary *)createAndReturnNSDictionary {
    ...
    NSDictionary *randomDictionary = @{@"sport" : @"basketball",
                                       @"city"  : @"NYC",
                                       @"team"  : @"Knicks"};
...
- (NSDictionary *)addEntriesToDictionary:(NSDictionary *)originalDictionary {
    ...
    //NSDictionary *originalDictionary = [[NSDictionary alloc] init];
    //[originalDictionary setObject: @"food" forKey: @"cheetos"];
    
    NSMutableDictionary *dictionaryToMerge = @{@"car" : @"honda",
                                               @"make" : @"pilot"};
    
    //NSDictionary *dict2 = [[NSDictionary alloc] initWithObjectsAndKeys:@"cheetos", @"food", nil];
    
    [dictionaryToMerge setObject:@"cheetos" forKey:@"food"];
    
    return dictionaryToMerge;
}
