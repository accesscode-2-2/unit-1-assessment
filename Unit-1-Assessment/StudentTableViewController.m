...
- (void)viewDidLoad {
    ...
    for (NSString *nameStudent in [Character allStudents]) {
        Character *person = [[Character alloc] init];
        person.name = nameStudent;
        person.picture = [[nameStudent lowercaseString] stringByReplacingOccurrencesOfString:@" " withString:@""];
                
        [self.students addObject:person];
    }
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    Character *person = [self.students objectAtIndex:indexPath.row];
